...
test_logs_home=$HOME/irods_test_env_ub14
test_name_prefix=
...
do
    docker run -d --rm --name ${test_name_prefix}${name} $test_hooks_volume_mount -v $test_logs_home:/irods_test_env irods_test_env:ub14 $name
done
